      ...
      <div className="px-4 py-6">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-['SF_Pro_Display'] font-bold text-gray-900 dark:text-white flex items-center">
                Welcome, {displayName}
                <Badge className="ml-3 bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200 hover:bg-indigo-100 border-none">
                  Level {learningJourney.currentLevel}
                </Badge>
              </h1>
              <p className="text-gray-600 dark:text-gray-300 mt-1 max-w-xl text-sm sm:text-base">
