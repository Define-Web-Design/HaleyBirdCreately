  ...
  const renderDesktopView = () => (
    <header className="bg-background/95 backdrop-blur-sm border-b border-border flex items-center justify-between px-5 py-2.5 h-16 sticky top-0 z-50 transition-all duration-300 ease-in-out">
      ...
      <div className="max-w-xl w-full mx-5">
        <div className="relative">
          ...
          {searchTerm ? (
            ...
            <button 
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-muted-foreground hover:text-foreground p-1.5"
      ...
      <div className="flex items-center gap-3">
        {/* Notification bell with improved touch targets */}
        <button 
          className="p-3 rounded-md hover:bg-accent/80 relative group transition-colors duration-200 focus:ring-2 focus:ring-primary focus:outline-none active:bg-accent"
          onClick={toggleNotifications}
          aria-label="Notifications"
        ...
        >
          ...
          {hasNotifications && (
            <span className="absolute top-2 right-2 w-2.5 h-2.5 bg-primary rounded-full ring-2 ring-background group-hover:animate-pulse"></span>
          )}
        </button>
        ...
        {/* User avatar with improved focus states */}
        <Link href="/profile" className="group focus:outline-none p-1.5 rounded-md focus:ring-2 focus:ring-primary">
          <div className="w-9 h-9 overflow-hidden rounded-full bg-muted flex items-center justify-center hover:ring-2 hover:ring-primary/50 transition-all duration-200 shadow-sm active:scale-95">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path>
