...
router.get('/mood-capsules', asyncHandler(async (req, res) => {
  try {
...
router.post('/mood-capsule', asyncHandler(async (req, res) => {
  try {
...
router.post('/mood-capsule/caption', asyncHandler(async (req, res) => {
  try {
